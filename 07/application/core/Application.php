...
abstract class Application
{
    ...
    * プロジェクトのルートディレクトリを取得
    * 
    * @return string ルートディレクトリへのファイルシステムの絶対パス
    */
    ...
    * @param array $params
    *
    * @throws HttpNotFoundException コントローラーが特定できない場合
    */
   ...
   /**
    * 指定されたコントローラー名から対応するControllerオブジェクトを取得
    * 
